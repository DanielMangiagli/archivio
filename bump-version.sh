...
step 5 "Updating docs/index.html and docs/index-it.html"
sed -i '' "s/v[0-9]*\.[0-9]*\.[0-9]*/v$VERSION/" docs/index.html
sed -i '' "s/Archivio_[0-9]*\.[0-9]*\.[0-9]*/Archivio_$VERSION/g" docs/index.html
sed -i '' "s/v[0-9]*\.[0-9]*\.[0-9]*/v$VERSION/" docs/index-it.html
sed -i '' "s/Archivio_[0-9]*\.[0-9]*\.[0-9]*/Archivio_$VERSION/g" docs/index-it.html
echo "  done"
